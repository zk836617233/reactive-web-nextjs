...
import type { aboutPropsType } from "@/types/index";
interface AboutDataType {
  aboutData: aboutPropsType;
}
const About: React.FC<AboutDataType> = ({ aboutData }) => {
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeInUp}>
            <Image src={boyImg} width={575} height={480} alt="img" />
          </motion.div>
        </motion.div>
      </div>
    </section>
